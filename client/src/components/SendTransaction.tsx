...
const SendTransaction: React.FC<Props> = ({ fromAddress }) => {
  ...
  let message = <p />;
  if (status === "PENDING")
    message = <p className="text-xs italic">Sign Tx with MetaMask...</p>;
  if (error)
    message = (
            ...
            <div className="bg-white border shadow-sm rounded-xl w-modal">
              ...
              <div className="p-4 overflow-y-auto">
                ...
                <input
                  type="text"
                  id="input-sender"
                  className="opacity-70 pointer-events-none py-3 px-4 block bg-gray-50 border-gray-800 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 w-full disabled:pointer-events-none"
                ...
                <input
                  ...
                  type="text"
                  id="input-recipient"
                  className="opacity-70 py-3 px-4 block bg-gray-50 border-gray-800 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 w-full disabled:pointer-events-none"
              ...
              <div className="flex justify-end items-center gap-x-2 py-3 px-4 border-t">
                <button
                  ...
                  type="button"
                  onClick={handleClear}
                  className="hs-dropdown-toggle py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm disabled:pointer-events-none"
                  data-hs-overlay="#hs-basic-modal"
                >
                  Close
                </button>
                <button
                  disabled={status === "PENDING"}
                  type="submit"
                  className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm disabled:pointer-events-none"
                >
                  Send
                </button>
              </div>
